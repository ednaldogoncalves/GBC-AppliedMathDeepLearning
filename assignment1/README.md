...
![screnshot](https://github.com/ednaldogoncalves/GBC-AppliedMathDeepLearning/tree/main/images/details_screenshot.png)

4. Near the bottom of the [Details]() page, you can see your score. Here are examples of 0/5 and 5/5:

![score](https://github.com/ednaldogoncalves/GBC-AppliedMathDeepLearning/tree/main/images/score.png) ![success](https://github.com/ednaldogoncalves/GBC-AppliedMathDeepLearning/tree/main/images/success.png)

5. When you achieve a perfect score, you will see a green checkmark near the commit ID.

![green](https://github.com/ednaldogoncalves/GBC-AppliedMathDeepLearning/tree/main/images/green.png)
